...
IFS=' ' read -r -a lplugins <<<"$(get_tmux_option '@tmux2k-left-plugins' 'cpu kubecontext')"
IFS=' ' read -r -a rplugins <<<"$(get_tmux_option '@tmux2k-right-plugins' 'bandwidth')"
...
declare -A plugin_colors=(
    ["kubecontext"]="blue text"
    ["cpu"]="purple text"
    ["ram"]="light_yellow text"
    ["bandwidth"]="light_purple text"
    ["network"]="purple text"
    ["ping"]="purple text"
    ["weather"]="yellow text"
...
set_theme() {
    ...
    if $icons_only; then
        ...
        text=$bg_main
        plugin_colors=(
            ["kubecontext"]="text blue"
            ["cpu"]="text purple"
            ["ram"]="text light_yellow"
            ["gpu"]="text yellow"
            ["battery"]="text light_purple"
            ["bandwidth"]="text light_purple"
            ["network"]="text purple"
            ["ping"]="text purple"
            ["weather"]="text yellow"
